...
Режим: полный обход, окно 2 суток. Запросов: 574. Заняло 2169 с.
...
| novasports.gr | расписание есть — 2 |
...
|---|---|---|---|
| jupiter.err.ee | ETV | HTTP 403; браузер: HTTP 403 (браузер), защита: cloudflare | https://services.err.ee/api/tvSchedule/getTimelineSchedule?day=24&month=9&year=2026&channel=etv |
| jupiter.err.ee | ETV | HTTP 403; браузер: HTTP 403 (браузер), защита: cloudflare | https://services.err.ee/api/tvSchedule/getTimelineSchedule?day=25&month=9&year=2026&channel=etv |
| jupiter.err.ee | ETV+ | HTTP 403; браузер: HTTP 403 (браузер), защита: cloudflare | https://services.err.ee/api/tvSchedule/getTimelineSchedule?day=24&month=9&year=2026&channel=etvpluss |
| jupiter.err.ee | ETV+ | HTTP 403; браузер: HTTP 403 (браузер), защита: cloudflare | https://services.err.ee/api/tvSchedule/getTimelineSchedule?day=25&month=9&year=2026&channel=etvpluss |
...
- ✅ обход в норме: не открылись 26 из 574 страниц (5%), сайтов без удачи 2 из 89 (2%)
