...
Режим: полный обход, окно 2 суток. Запросов: 513. Заняло 1758 с.
...
|---|---|---|---|
| liveonsat.com | сетка | cloudflare turnstile | https://liveonsat.com/2day.php?start_dd=17&start_mm=09&start_yyyy=2026&end_dd=17&end_mm=09&end_yyyy=2026&postponed=0 |
| rtrs.tv | сетка | ConnectTimeout: HTTPSConnectionPool(host='www.rtrs.tv', port=443): Max retries exceeded with url: /program/raspored.php?c=1 (Caused by ConnectTimeoutError(<HTTP | https://www.rtrs.tv/program/raspored.php?c=1 |
...
- ✅ обход в норме: не открылись 2 из 512 страниц (0%), сайтов без удачи 2 из 88 (2%)
